    ...
    if (messageStatus == "successfully sent") {
      return (
        <div className="greeter__success">
          <div className="success__text">Message Sent Successfully</div>
        </div>
      );
    }
    ...
    return (
      <div>
        ...
        <div className="contact__greeter">
          <div className="greeter__sentence--my-name">{" Hey Vikram, "}</div>
          <div className="greeter__sentence">this is</div>
          <input
            value={greeterName}
            name="greeterName"
            onChange={(event) => this.handleChange(event)}
            className="greeter__input--name"
            placeholder="Name"
          />
          <br />
          <div className="greeter__sentence">let's have a quick chat at</div>
          <input
            value={contactDetail}
            name="contactDetail"
            onChange={(event) => this.handleChange(event)}
            className="greeter__input--email"
    ...
    return (
      <Layout>
        <div className="contact">
          <div className="contact__header--getInTouch">GET IN TOUCH</div>
          <div className="contact__header">Email me at</div>
          <div className="contact__info">chandra.ck101@gmail.com</div>
          <div className="contact__header">Or ring me on</div>
          <div className="contact__info">+1 (682) 232-3546</div>
